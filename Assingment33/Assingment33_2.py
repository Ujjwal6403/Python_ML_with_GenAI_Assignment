...
def CreateLog(FolderName):
    ...
    ########################################################
    # Process + Thread + Open Files Monitoring
    Data = ProcessScan()

    fobj.write("\nProcess, Thread and Open Files Monitoring Report\n")
    fobj.write(Border+"\n")
...
def ProcessScan():
    ...
    for proc in psutil.process_iter():
        try:
            ...
            # 🔥 Open Files Count (System-level call)
            try:
...
def main():
    ...
    if(len(sys.argv) == 2):
        ...
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("7 : Store information about Threads")
            print("8 : Store information about Open Files (New Feature)")
